                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <a href="{{ route('reader.profile') }}"><button class="btn btn-primary"><b><i style="margin-right:5px" class="fa fa-edit"></i> EDIT</b></button></a>
                                </div>
                                <div class="col-md-1">
                                    <a href="{{ route('reader.dashboard') }}"><button class="btn btn-primary"><b>BACK</b></button></a>
                                </div>

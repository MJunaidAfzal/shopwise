                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <a href="{{ route('user.blog.create') }}"><button class="btn btn-primary"><b>CREATE BLOG</b></button></a>
                            </div>
                        </div>
                        <div class="col-md-12 mt-5">
                         ...
                         <tbody>
                            <tr>
                                <td>{{ ++$index }}</td>
                                <td>{{ $blog->title }}</td>
                                <td class="text-center" style="width: 10%;"><a  href="{{ url('/').'/upload/blog/'. $blog->image }}" target="_blank"><i class="fa fa-image"></i></a></td>
                                <td>
                                    @if($blog->status == 1)
                                ...
                                <td>
                                    <a href="{{ route('blog-detail',$blog->slug) }}"><i class="text-success fa fa-eye"></i> </a>&nbsp;|&nbsp;
                                    <a href="{{ route('user.blog.edit',$blog->slug) }}"><i class="text-info fa fa-edit"></i> </a>&nbsp;|&nbsp;

                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <a type="button" class="btn btn-primary" href="{{ route('user.dashboard') }}"><b>BACK</b></a>
                                </div>
                                <div class="col-md-2">
                                    <a type="button" class="btn btn-primary" href="{{ route('user.profile.view') }}"><i style="margin-right: 5px" class="fa fa-eye"></i> <b>VIEW</b></a>
                                </div>
                            </div>

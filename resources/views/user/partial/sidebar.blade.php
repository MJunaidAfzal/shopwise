...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li @if(url()->current() == Route::is('user.dashboard')) class="menu-item active" @endif class="menu-item">
            <a href="{{ route('user.dashboard') }}" class="mt-2 menu-link">
              <i style="margin-right: 10px;" class="fa fa-dashboard"></i>
              <div>Dashboard</div>
            </a>
          </li>

          <li @if(url()->current() == Route::is('user.profile')) class="menu-item" @endif class="menu-item">
            <a href="{{ route('user.profile') }}" class="mt-2 menu-link">
              <i style="margin-right: 10px;" class="fa fa-user"></i>
              <div>Profile</div>
            </a>
          </li>

          <li @if(url()->current() == Route::is('user.blog.index','user.blog.create','user.blog.edit')) class="menu-item" @endif class="menu-item">
          ...
          <li @if(url()->current() == Route::is('user.blog.favourite')) class="menu-item" @endif class="menu-item">
            <a href="{{ route('user.blog.favourite') }}" class=" menu-link">
              <i style="margin-right: 10px;" class="fa fa-heart"></i>
              <div>Favourite Blogs</div>
            </a>
          </li>

          <li @if(url()->current() == Route::is('user.review.index')) class="menu-item" @endif class="menu-item">
            <a href="{{ route('user.review.index') }}" class=" menu-link">
              <i style="margin-right: 10px;" class="fa fa-star"></i>
              <div>My Reviews</div>
            </a>
          </li>

          <li @if(url()->current() == Route::is('user.order.index','user.order.view')) class="menu-item" @endif class="menu-item">

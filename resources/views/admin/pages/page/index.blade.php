                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <a href="{{ route('admin.page.create') }}"><button class="btn btn-primary"><b>CREATE PAGE</b></button></a>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped" id="table">
                             ...
                             <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.page.edit',$page->slug) }}"><i class="text-info fa fa-edit"></i> </a>&nbsp;|&nbsp;

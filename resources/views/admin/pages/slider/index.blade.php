                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <a href="{{ route('admin.slider.create') }}"><button style="float: right" class="btn btn-primary"><b>CREATE SLIDER</b></button></a>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped" id="table">
                             ...
                             <tbody>
                                <tr>
                                    <td>{{ ++$index }}</td>
                                    <td>{{ $slider->name }}</td>
                                    <td class="text-center" style="width: 10%;"><a  href="{{ url('/').'/upload/slider/'. $slider->image }}" target="_blank"><i class="fa fa-image"></i></a></td>
                                    <td>{{ $slider->link }}</td>
                                    <td>
                                        @if($slider->status == 1)
                                    ...
                                    <td>
                                        <a href="{{ route('admin.slider.edit',$slider->id) }}"><i class="text-info fa fa-edit"></i> </a>&nbsp;|&nbsp;

                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <a href="{{ route('admin.brand.create') }}"><button style="float: right" class="btn btn-primary"><b>CREATE BRAND</b></button></a>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped" id="table">
                             ...
                             <tbody>
                                <tr>
                                    <td>{{ ++$index }}</td>
                                    <td>{{ $brand->name }}</td>
                                    <td class="text-center" style="width: 10%;"><a  href="{{ url('/').'/upload/brand/'. $brand->image }}" target="_blank"><i class="fa fa-image"></i></a></td>
                                    <td>
                                        @if($brand->status == 1)
                                    ...
                                    <td>
                                        <a href="{{ route('admin.brand.edit',$brand->slug) }}"><i class="text-info fa fa-edit"></i> </a>&nbsp;|&nbsp;

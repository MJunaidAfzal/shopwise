               ...
               <div class="card">
                  <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="{{ route('admin.brand.index') }}"><button class="btn btn-primary w-100"><b>BACK</b></button></a>
                        </div>
                    </div>
                  {!! Form::model($brand, ['route'=> ['admin.brand.update', $brand->slug],'class' =>'mt-5' , 'enctype' => 'multipart/form-data']) !!}
                    @method('PUT')
                     <div class="row">
                        <div class="col-md-6 mt-4">
                         ...
                         <div class="col-md-6 mt-4">
                            ...
                            <img src="{{asset('upload/brand/'.$brand->image)}}" alt="" width="100px" class="img-thumbnail mt-3">
                        @endif
                        </div>
                         <div class="col-md-6 mt-4">
                           <div class="form-floating">
